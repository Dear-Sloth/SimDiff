...
if __name__ == '__main__':
    ...
    parser.add_argument('--skip_dropout', type=float, default=0.1, help='dropout')
    ...
    parser.add_argument('--s_steps', type=int, default=5, help='number of sample steps')
    ...
    parser.add_argument('--order', type=int, default=2, help='order of sampler')   
    ...
    parser.add_argument('--use_shuffle', type=int, default=1)
    parser.add_argument('--use_first', type=int, default=0)
    # optimization
